...
// function textFields3Change(textFields3){

//     return {
//         type: textFields3.type,
//         ask: '<li class="mt-75"> <p class="fw-b lh-15" style="text-align: justify;">' + textFields3.ask + '</p> <div class="question2 mt-75"> <form class="q-form">',
//         answer: 
...
// var textFields4 = textFields3.map(textFields3Change)
